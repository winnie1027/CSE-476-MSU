...
public class Cloud {
    ...
    private static final String BASE_URL = "https://webdev.cse.msu.edu/~yangyi20/cse476/step6/";
    public static final String CATALOG_PATH = "hatter-cat.php";
    public static final String SAVE_PATH = "https://webdev.cse.msu.edu/~yangyi20/cse476/step6/hatter-save.php";
    public static final String DELETE_PATH = "https://webdev.cse.msu.edu/~yangyi20/cse476/step6/hatter-delete.php";
    public static final String LOAD_PATH = "https://webdev.cse.msu.edu/~yangyi20/cse476/step6/hatter-load.php";
